...
export default function Week9() {
    return (
        <Container className="border border-primary border-2 m-2 bg-white">
            <Row>
                <h1 className="text-center text-success fw-bold">Week 9</h1>
            </Row>
            <Row>
                <h3 className="text-center text-success fw-bold">Local Storage</h3>
            </Row>
            <p className="text-primary">When I first accepted my place in the bootcamp, I had some thoughts on what coding was going to be like, but obviously not completely sure. One of the
            ...
            <p className="text-primary">I think for me the thing I dislike most about the CLI is the amount of different commands there are and how many commands you need to use to accomplish a
            ...
            <p className="text-primary">As we have used react more and introduced some of the more advanced features of it I have come to realize just how much less code I am actually writing. Even

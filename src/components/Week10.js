...
export default function Week10() {
    return (
        <Container className="border border-primary border-2 m-2 bg-white">
            <Row>
                <h1 className="text-center text-success fw-bold">Week 10</h1>
            </Row>
            <Row>
                <h3 className="text-center text-success fw-bold">Hooks and Router!</h3>
            </Row>
            <p className="text-primary">The last 3 weeks of react have been mind blowing. After 7 weeks of vanilla JavaScript with HTML and CSS, react has completely changed how I can approach
            ...
            <p className="text-primary">For me the biggest hurdle has been syntax and being able to troubleshoot my own mistakes. I have confidence in my ability to take a problem, understand it,
            ...
            <p className="text-primary">Being a huge sports fan my original idea for my final project was to do an app that could get the scores for your favorite team. After working through our react

...
export default function Week7() {
    return (
        <Container className="border border-primary border-2 m-2 bg-white">
            <Row>
                <h1 className="text-center text-success fw-bold">Week 7</h1>
            </Row>
            <Row>
                <h3 className="text-center text-success fw-bold">Models, Views, and Controllers oh my!</h3>
            </Row>
            <p className="text-primary">This week was a great example of why pseudocode is so important to production. Pseudocode is a way for programmers to get the logic, data structers, and
            ...
            <p className="text-primary">Model, view, controller is a very common design pattern that makes it easy to define roles and resposibilities for your objects. In the MVC desing pattern
